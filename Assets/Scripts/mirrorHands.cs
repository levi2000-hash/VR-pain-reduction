...
public class mirrorHands : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        obj2.transform.rotation = new Quaternion(obj2.transform.rotation.x+ obj1.transform.rotation.x,
                                            obj2.transform.rotation.y + obj1.transform.rotation.y,
                                            obj2.transform.rotation.z + obj1.transform.rotation.z,
                                            obj2.transform.rotation.w + obj1.transform.rotation.w * -1.0f);
    }
}
